...
class Seq2SeqModel(object):
    def __init__(self, rnn_size, num_layers, embedding_size, learning_rate, word_to_idx, mode, use_attention,
                 beam_search, beam_size, 1='LSTM', max_gradient_norm=5.0):
    ...
    def encoder(self):
        ...
        embedding是vocab_size * embedding_size的矩阵
        encoder_inputs_embedded是encoder_inputs每个元素在embedding矩阵中对应的向量组成的矩阵
        encoder_inputs_embedded维度（）
